![MasterHead](https://miro.medium.com/v2/resize:fit:720/format:webp/1*ZRkfBYvJzvvmgKboAJoHxQ.png)
...
- 🌍 here are some of my projects
    <ul style="display: flex; flex-direction: column; padding: 0;margin: 0; ">
        ...
        <li style="list-style: none;">
            <a href="https://github.com/brunobernalsalaberria/CampusVirtual">
                Campus virtual (Laravel)
            </a>
        </li>

        <li style="list-style: none;">
            <a href="https://github.com/brunobernalsalaberria/machine_learning">
                Machine Learning projects
            </a>
        </li>

        <li style="list-style: none;">
            <a href="https://github.com/brunobernalsalaberria/api_feedback_google">
                Feedback API with Google Cloud
            </a>
        </li>

        <li style="list-style: none;">
            <a href="https://github.com/brunobernalsalaberria/red_neuronal_convolucional">
                CNN Image Classification
            </a>
        </li>

        <li style="list-style: none;">
            <a href="https://github.com/brunobernalsalaberria/sistemas_aprendizaje_automatico">
